...
export default class PresellItem extends React.Component {
	...
	handleCountDownTitleBgColorChange = (color) => {
		this.store.updateModule(this.props.uid, { countDownTitleBgColor: color });
	}
                ...
                <div className="form-item">
                    ...
                    <div className="form-item-content">
						<div className="item-block">
                            <label className="clearfix">标题字体色<ColorPick color={countDownTitleColor} onChange={this.handleCountDownTitleColorChange} /></label>
                        </div>
						<div className="item-block">
                            <label className="clearfix">标题背景色<ColorPick color={countDownTitleBgColor} onChange={this.handleCountDownTitleBgColorChange} /></label>
                        </div>
						<div className="item-block">

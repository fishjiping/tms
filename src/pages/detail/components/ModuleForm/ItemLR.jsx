...
@inject('store')
@observer
export default class ItemLR extends React.Component {
	constructor(props) {
        super(props);
	...
	handleBtnFontColorChange = (color) => {
		this.store.updateModule(this.props.uid, { btnFontColor: color });
	}
	...
	render() {
		...
		return (
			<div>
                ...
                <div className="form-item">
                    <p className="form-item-title">按钮颜色</p>
                    <div className="form-item-content">
                        <div className="item-block">
                            <label className="clearfix">字体色<ColorPick color={btnFontColor} onChange={this.handleBtnFontColorChange} /></label>
                        </div>
						<div className="item-block">
                            <label className="clearfix">背景色<ColorPick color={btnColor} onChange={this.handleBtnColorChange} /></label>
                        </div>
                    </div>
                </div>
                <div className="form-item">
